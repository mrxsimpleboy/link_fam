...
class _LoginpageWidgetState extends State<LoginpageWidget> {
  ...
  Widget build(
    ...
    return Scaffold(
        ...
        body: Container(
            width:
                MediaQuery.of(context).size.width * 0.98, //414.0000305175781,
            height:
                MediaQuery.of(context).size.height * 0.98, //896.0000610351562,
                ...
                children: <Widget>[
                  ...
                  Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image:
                                AssetImage('assets/images/login/Ellipse1.png'),
                            fit: BoxFit.fill),
                        borderRadius:
                            BorderRadius.all(Radius.elliptical(89, 83)),
                      )),
                  // Positioned(
                  //   top: 417.857421875,
